...
images: [ img15,],
      ...
      coverage: "1.2 กก./ตร.ม. @ 1000 ไมครอน ",
...
images: [ img16,],
      ...
      coverage: [ "12.4 กก./ตร.ม. @ 6000 ไมครอน ", "12.4 กก./ตร.ม. @ 6000 ไมครอน ",
      ],
...
images: [ img18,],
      ...
      coverage: [ "1.75 กก./ตร.ม. @ 1000 ไมครอน ", "3.5 กก./ตร.ม. @ 2000 ไมครอน  ",],
...
images: [ img20,],
      ...
      coverage: [ "4.5 กก./ตร.ม. @ 3000 ไมครอน ", "7.5 กก./ตร.ม. @ 5000 ไมครอน  ",],
  ...
  products: [
    {
      ...
      coverage: [ "0.15 กก./ตร.ม. @ 50 ไมครอน 0.20 กก./ตร.ม. @ 100 ไมครอน  ",],
...

    {
      ...
      coverage: [ "1.0 กก./ตร.ม. @ 0.8 มม. 1.28 กก./ตร.ม. @ 1 มม.  ",],
      package: [
        "4 กก./ชุด (ส่วน A = 3.2 กก., ส่วน B = 0.8 กก.)",
        "20 กก./ชุด (ส่วน A = 16 กก., ส่วน B = 4 กก.) ",
      ],
      ...
      coverage: [ "1.625 กก./ตร.ม. @ 1000 ไมครอน 3.25 กก./ตร.ม. @ 2000 ไมครอน ",],
      package: [
      ...
      coverage: [ "1.45 Kg/m2 @ 1000 ไมครอน ",],
      package: [
        "20 กก./ชุด (ส่วน A = 16 กก. , ส่วน B = 4 กก.)"
      ],
    },
  ...
  products: [
    {
      ...
      coverage: [ "1.25 กก./ตร.ม. @ 1.0 มม. 2.5 กก./ตร.ม. @ 2.0 มม.  ",],
...
images: [ img36,],
      ...
      coverage: "1.97-2.6 กก./ตร.ม. @ 1.5-2.0 มม.",     
